            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="add-product">
                        <h1 class="text-center my-3">Thêm bài học vào khóa học</h1>
                        <form class="border p-4 rounded" action="" method="POST">
                            <div class="mb-3">
                                <select class="form-select" aria-label="Default select example" name="course_id">
                                    <option selected value="0">Chọn khóa học thêm bài học</option>
                                    <?php
                            ...
                            <div class="form-group d-flex justify-content-end">
                                <input class="btn btn-primary" type="submit" value="Thêm vào khóa học" name="insertLessonToCourseBtn" />
                            </div>
                        </form>
                    </div>
                </div>
