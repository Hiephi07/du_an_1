                ...
                <div class="tile-body">
                    <div class="add-product">
                        ...
                        <form class="border p-4 rounded" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="chapter_order" class="form-label">Thêm bài học vào chương</label>
                                            ...
                                            ?>
                                                ...
                                                <?php
                                                    if (isset($_POST['chapter_id'])) {
                                                        echo ($_POST['chapter_id']==$chapter['chapter_id'])?"selected":false;
                                                    } 
                                                ?>
                                                >
                            ...
                            <!-- <div class="mb-3">
                                <input type="hidden" class="form-control bg-white" id="course_id" name="course_id" value="<?php if (isset($_POST['course_id'])) echo $_POST['course_id']; else echo $courseId?>"/>
                            </div> -->
                            <div class="mb-3">
