...
function checkLoginName($loginName) {
    $sql = "SELECT * FROM users WHERE user_name='$loginName'";
    return pdo_query_one($sql);
}
...
function insertUser($loginName, $user_name, $userPassword, $userAvatar, $userEmail, $userRole) {
    $sql = "INSERT INTO users(username, user_name, user_password, user_avatar, user_email, roles) VALUES('$loginName', '$user_name', '$userPassword', '$userAvatar', '$userEmail', '$userRole')";
    return pdo_checkStatusSql($sql);
}
